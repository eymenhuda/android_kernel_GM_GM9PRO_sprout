...
{
	struct tfa98xx *tfa98xx = dev_get_drvdata(component->dev);
	int ret;
	...
	snd_soc_component_set_drvdata(component, tfa98xx);
...
static void tfa98xx_component_remove(struct snd_soc_component *component)
{
	struct tfa98xx *tfa98xx = snd_soc_component_get_drvdata(component);
	pr_debug("\n");
...
static const struct snd_soc_component_driver soc_component_dev_tfa98xx = {
	...
	.remove = tfa98xx_component_remove,
